    ...
    <div class="mb-60">
        <div class="bg-white">            
            <div class="row align-items-start d-flex">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 m-0 pt-15 pl-15 pb-30 d-flex flex-column align-items-center" style="background-color: #197d5c;background-repeat: no-repeat; background-size: cover; min-height: 300px;">
